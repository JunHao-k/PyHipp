...
DPT.objects.processDirs(dirs=None, objtype=pyh.RPLParallel, 
saveLevel=1); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:721468676325:awsnotify --message "RPLParallelJobDone"
